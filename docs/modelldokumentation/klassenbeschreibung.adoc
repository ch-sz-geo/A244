...
Die Stammdaten werden durch die zuständige Stelle vorgegeben, bei Bedarf durch die Abteilung Geoinformation nachgeführt und im https://github.com/ch-sz-geo/A244/tree/main/data[data-Verzeichnis] des jeweiligen Themas veröffentlicht.
...
==== Klasse `+Profilart+`
Klasse, welche Auskunft darüber gibt, was im Bohrprofil dargestellt wird (entweder geologische Einheit oder tektonische Strukturen). Hintergrund: Kapitel 2.2.1.1 in <<impressum.adoc#doc-06,[06]>>. Die Werte von `+Code+` entsprechen den Werten gemäss den Angaben in <<impressum.adoc#doc-06,[06]>> und dienen der Zuordnung bei der Transformation ins Bundesmodell. Die Werte von `+Name+` wurden zum Teil leicht angepasst.
...
==== Klasse `+Profiltyp+`
Klasse, welche Auskunft darüber den Typ des Bohrprofils Auskunft gibt (z.B. "Originalaufnahme"). Hintergrund: Kapitel 2.2.1.2 in <<impressum.adoc#doc-06,[06]>>. Die Werte von `+Code+` entsprechend den Werten gemäss den Angaben in <<impressum.adoc#doc-06,[06]>> und dienen der Zuordnung bei der Transformation ins Bundesmodell. Die Werte von `+Name+` wurden zum Teil leicht angepasst.
...
Klasse, welche die Bereiche der Einfallswinkel als Auswahlliste zur Verfügung stellt. Hintergrund: Kapitel 1.1.8 in <<impressum.adoc#doc-06,[06]>>. Die Werte von `+Code+` entsprechend den Werten gemäss den Angaben in <<impressum.adoc#doc-06,[06]>> und dienen der Zuordnung bei der Transformation ins Bundesmodell. Die Werte von `+Name+` wurden zum Teil leicht angepasst.
...
==== Klasse `+Strukturtyp+`
Klasse, welche die Werte des Typs der erbohrten tektonischen Struktur zur Verfügung stellt. Hintergrund: Kapitel 2.2.5.1 <<impressum.adoc#doc-06,[06]>>. Die Werte von `+Code+` entsprechend den Werten gemäss den Angaben in <<impressum.adoc#doc-06,[06]>> und dienen der Zuordnung bei der Transformation ins Bundesmodell. Die Werte von `+Name+` wurden zum Teil leicht angepasst.
...
Klasse, welche die Werte für die Klassifikation der Haupt- und Nebenkomponente oder des gesamten Materials gemäss leicht erweiterter SN 670 004-2b-Norm zur Verfügung stellt. Hintergrund: Kapitel 2.2.4.1 in <<impressum.adoc#doc-06,[06]>>. Die Werte von `+Code+` entsprechend den Werten gemäss den Angaben in <<impressum.adoc#doc-06,[06]>> und dienen der Zuordnung bei der Transformation ins Bundesmodell. Die Werte von `+Name+` wurden zum Teil leicht angepasst.
...
==== Klasse `+Korngroesse+`
Klasse, welche die Werte der Korngrösse der Hauptkomponente zur Verfügung stellt. Hintergrund: Kapitel 2.2.4.2 in <<impressum.adoc#doc-06,[06]>>. Die Werte von `+Code+` entsprechend den Werten gemäss den Angaben in <<impressum.adoc#doc-06,[06]>> und dienen der Zuordnung bei der Transformation ins Bundesmodell. Die Werte von `+Name+` wurden zum Teil leicht angepasst.
...
==== Klasse `+Kornrundung+`
Klasse, welche die Werte der Kornrundung der Grobkomponenten geäss erweiterter EN-14688-1 Norm zur Verfügung stellt. Hintergrund: Kapitel 2.2.4.3 in <<impressum.adoc#doc-06,[06]>>. Die Werte von `+Code+` entsprechend den Werten gemäss den Angaben in <<impressum.adoc#doc-06,[06]>> und dienen der Zuordnung bei der Transformation ins Bundesmodell. Die Werte von `+Name+` wurden zum Teil leicht angepasst.
...
==== Klasse `+Plastizitaet+`
Klasse, welche die Werte der Plastizität des Lockergesteins gemäss SN 670 004-2b-Norm zur Verfügung stellt. Hintergrund: Kapitel 2.2.4.4 in <<impressum.adoc#doc-06,[06]>>. Die Werte von `+Code+` entsprechend den Werten gemäss den Angaben in <<impressum.adoc#doc-06,[06]>> und dienen der Zuordnung bei der Transformation ins Bundesmodell. Die Werte von `+Name+` wurden zum Teil leicht angepasst.
...
==== Klasse `+Konsistenz+`
Klasse, welche die Werte der Konsistenz des Lockergesteins gemäss SN 670 004-2b-Norm zur Verfügung stellt. Hintergrund: Kapitel 2.2.4.5 in <<impressum.adoc#doc-06,[06]>>. Die Werte von `+Code+` entsprechend den Werten gemäss den Angaben in <<impressum.adoc#doc-06,[06]>> und dienen der Zuordnung bei der Transformation ins Bundesmodell. Die Werte von `+Name+` wurden zum Teil leicht angepasst.
...
==== Klasse `+Feuchte+`
Klasse, welche die Werte der Feuchte des Lockergesteins zur Verfügung stellt. Hintergrund: Kapitel 2.2.4.6 in <<impressum.adoc#doc-06,[06]>>. Die Werte von `+Code+` entsprechend den Werten gemäss den Angaben in <<impressum.adoc#doc-06,[06]>> und dienen der Zuordnung bei der Transformation ins Bundesmodell. Die Werte von `+Name+` wurden zum Teil leicht angepasst.
...
==== Klasse `+Kohaesion+`
Klasse, welche die Werte der Kohäsion des Lockergesteins zur Verfügung stellt. Hintergrund: Kapitel 2.2.4.7 in <<impressum.adoc#doc-06,[06]>>. Die Werte von `+Code+` entsprechend den Werten gemäss den Angaben in <<impressum.adoc#doc-06,[06]>> und dienen der Zuordnung bei der Transformation ins Bundesmodell. Die Werte von `+Name+` wurden zum Teil leicht angepasst.
...
==== Klasse `+Organik+`
Klasse, welche die Werte des organischen Materials des Lockergesteins zur Verfügung stellt. Hintergrund: Kapitel 2.2.4.8 in <<impressum.adoc#doc-06,[06]>>. Die Werte von `+Code+` entsprechend den Werten gemäss den Angaben in <<impressum.adoc#doc-06,[06]>> und dienen der Zuordnung bei der Transformation ins Bundesmodell. Die Werte von `+Name+` wurden zum Teil leicht angepasst.
...
==== Klasse `+Kornform+`
Klasse, welche die Werte der Kornform gemäss erweiteter EN-14688-1 zur Verfügung stellt. Hintergrund: Kapitel 2.2.4.9 in <<impressum.adoc#doc-06,[06]>>. Die Werte von `+Code+` entsprechend den Werten gemäss den Angaben in <<impressum.adoc#doc-06,[06]>> und dienen der Zuordnung bei der Transformation ins Bundesmodell. Die Werte von `+Name+` wurden zum Teil leicht angepasst.
...
==== Klasse `+Farbe+`
Klasse, welche die Werte der Farbe des Lockergesteins zur Verfügung stellt. Hintergrund: Kapitel 2.2.4.10 in <<impressum.adoc#doc-06,[06]>>. Die Werte von `+Code+` entsprechend den Werten gemäss den Angaben in <<impressum.adoc#doc-06,[06]>> und dienen der Zuordnung bei der Transformation ins Bundesmodell. Die Werte von `+Name+` wurden zum Teil leicht angepasst.
...
Klasse, welche die Werte der Verwitterung des Lockergesteins zur Verfügung stellt. Hintergrund: Kapitel 2.2.4.11 in <<impressum.adoc#doc-06,[06]>>. Die Werte von `+Code+` entsprechend den Werten gemäss den Angaben in <<impressum.adoc#doc-06,[06]>> und dienen der Zuordnung bei der Transformation ins Bundesmodell. Die Werte von `+Name+` wurden zum Teil leicht angepasst.
...
Klasse, welche die Werte der Lagerungsdichte des Lockergesteins gemäss SN 670 004-2b Norm zur Verfügung stellt. Hintergrund: Kapitel 2.2.4.12 in <<impressum.adoc#doc-06,[06]>>. Die Werte von `+Code+` entsprechend den Werten gemäss den Angaben in <<impressum.adoc#doc-06,[06]>> und dienen der Zuordnung bei der Transformation ins Bundesmodell. Die Werte von `+Name+` wurden zum Teil leicht angepasst.
...
==== Klasse `+Bodenzustand+`
Klasse, welche die Werte des Bodenzustandes des Lockergesteins gemäss SN 670 004-2b Norm zur Verfügung stellt. Hintergrund: Kapitel 2.2.4.13 in <<impressum.adoc#doc-06,[06]>>. Die Werte von `+Code+` entsprechend den Werten gemäss den Angaben in <<impressum.adoc#doc-06,[06]>> und dienen der Zuordnung bei der Transformation ins Bundesmodell. Die Werte von `+Name+` wurden zum Teil leicht angepasst.
...
Klasse, welche die Werte des Bestimmungstyps zur Klassifikation des Lockergesteins zur Verfügung stellt. Hintergrund: Kapitel 2.2.4.14 in <<impressum.adoc#doc-06,[06]>>. Die Werte von `+Code+` entsprechend den Werten gemäss den Angaben in <<impressum.adoc#doc-06,[06]>> und dienen der Zuordnung bei der Transformation ins Bundesmodell. Die Werte von `+Name+` wurden zum Teil leicht angepasst.
...
Klasse, welche die Werte des Gewissheitsgrades führt. Der Gewissheitsgrad bezieht sich immer auf den über die Rollenbezeichnung definierten Kontext und tritt nur in Verbindung mit der Klasse `+Grundwasser+` auf. Dabei bedeutet zum Beispiel ein "ja" bei der Rolle `+rGrundwasserspannung+`, dass das Grundwasser mit Sicherheit gespannt ist. Als weiteres Beispiel würde ein "nein" bei der Rolle `+rTiefenstockwerk+` bedeuten, dass kein Tiefenstockwerk vorhanden ist.
...
Die durch das Fachamt bewirtschafteten Kataloge sind dem Topic `+Fachkataloge+` zugeordnet.
...
(in <<impressum.adoc#doc-06,[06]>>: [Borehole.Elevation_Z]; in Datenquelle: [okt])
| 785.86
| öffentlich
m| Laenge
| Gemessene Länge der Bohrung in Meter. +
(in <<impressum.adoc#doc-06,[06]>>: [Borehole.Length]; in Datenquelle: [tiefe])
| 112.56
| öffentlich
m| Tiefe
| Tatsächliche, vertikale Tiefe der Bohrung; Höhendifferenz zwischen dem Bohrlandepunkt und der Ansatzhöhe (siehe Abb. 9 in <<impressum.adoc#doc-06,[06]>>). +
...
(in <<impressum.adoc#doc-06,[06]>>: [Borehole_Extended.Top_Bedrock]; in Datenquelle: [tiefefelsoberflaeche])
| 6.5
| öffentlich
m| Bohrbeginn
...
(in <<impressum.adoc#doc-06,[06]>>: [Borehole.Date]; in Datenquelle: [datum])
| 1985-10-02
| öffentlich
m| Einfallswinkel
...
(in <<impressum.adoc#doc-06,[06]>>: [Borehole.Borejnc]; in Datenquelle: [datum])
| 0
| öffentlich
m| hatWasser
| Schalter, um anzugeben, ob bei der Bohrung auf Wasser gestossen wurde (ja/nein). +
(in <<impressum.adoc#doc-06,[06]>>: [Borehole_Extended.Groundwater]; in Datenquelle: [grundwasserangetroffen])
| ja
| öffentlich
m| Wassertiefe
...
| öffentlich
m| rWasserart
| Verweis auf ein oder mehrere Objekte der Klasse `+Wasserart+`, falls auf Wasser gestossen wurde
...
(in <<impressum.adoc#doc-06,[06]>>: [Borehole_Extended.Original_Name]; in Datenquelle: [bezeichnunggeobericht])
| SB 12.05-08
| öffentlich
m| Erstelldatum
...
(in <<impressum.adoc#doc-06,[06]>>: [Stack.isMain])
| ja
| öffentlich
m| Dokumentlink
...
((in <<impressum.adoc#doc-06,[06]>>: [DrillCompl.ElvRefHeight])
| 871.02
| öffentlich
m| Beschreibung
| Beschreibung des Bohrlochausbaus. +
(in <<impressum.adoc#doc-06,[06]>>: [DrillCompl.Descr])
...
(in <<impressum.adoc#doc-06,[06]>>: [GeolLayer.GeolDescr])
| todo
| öffentlich
4+| *Geometrie*
| - - -
...
4+| *Beziehungsattribute*
m| rBohrprofil
| Verweis auf ein Objekt der Klasse `+Bohrprofil+`
| (OID des Objektes)
| öffentlich
m| rSetzungspotential
| Verweis auf ein Objekt der Klasse `+Setzungspotential+`
...
(in <<impressum.adoc#doc-06,[06]>>: [TectoLayer.DepthFrom])
| 15.8
| öffentlich
m| TiefeBis
...
(in <<impressum.adoc#doc-06,[06]>>: [TectoLayer.DepthTo])
| 16.2
| öffentlich
m| Beschrieb
| Beschreibung der erbohrten tektonischen Struktur +
(in <<impressum.adoc#doc-06,[06]>>: [TectoLayer.LayerDescr])
| todo
| öffentlich
m| Einfallswinkel
...
(in <<impressum.adoc#doc-06,[06]>>: [TectoLayer.RelDip])
| 0
| öffentlich
4+| *Geometrie*
| - - -
...
| öffentlich
m| rStrukturtyp
| Verweis auf ein Objekt der Klasse `+Strukturtyp+`
...
=== Topic `+Hydrogeologie+`
Das Topic `+Hydrogeologie+` führt Informationen zur Hydrogeologie. Es umfasst die Klasse `+Grundwasser+`.

==== Klasse `+Grundwasser+`
Stösst man bei einer Bohrung auf Wasser, werden Daten erhoben, die auf der Klasse `+Grundwasser+` erfasst werden.
...
| öffentlich
m| rTiefenstockwerk
| Verweis auf ein Objekt der Klasse `+Gewissheitsgrad+` +
Gibt den Grad der Gewissheit an, ob ein tieferes Grundwasserstockwerk vorhanden ist.
| (OID des Objektes)
| öffentlich
m| rGrundwasserspannung
| Verweis auf ein Objekt der Klasse `+Gewissheitsgrad+` +
Gibt den Grad der Gewissheit an, ob das Grundwasser gespannt ist.
| (OID der Lithologie)
| öffentlich
4+| *Erfassungsregeln*
m| GWKote
3+| Der Wert wird nur erfasst, falls `+rGrundwasserspannung+` auf einen der folgenden Werte verweist: "ja", "vermutet".
|===
