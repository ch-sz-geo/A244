...
-> todo: Werte in Masterkatalog aufnehmen +
Klasse, welche die Werte zum Gewissheitsgrad enthalten.
...
| öffentlich
m| GWSpiegelUT
| Höhe unter Terrain, auf welcher der Grundwasserspiegel zu liegen kommt (gespannt und freie Druckverhältnisse)
| todo
| öffentlich
m| GWLeiterUT
| Höhe unter Terrain, ab welcher der Grundwasserleiter beginnt (Gesteinsmedium, welches das Grundwasser enthält)
| todo
| öffentlich
m| GWStauerUT
| Höhe unter Terrain, ab welcher das Grundwasservorkommen nach unter durch eine dichte Schicht abgeschlossen wird
| todo
| öffentlich
m| GWMaechtigkeit
| todo
...
| öffentlich
m| GWKote
| Höhe, auf welcher der Grundwasserspiegel in freien Druckverhältnissen zu liegen kommen würde.
| todo
| öffentlich
m| GWTemperatur
| todo
...
| öffentlich
m| GwspAbsenkung
| Resuktion des Grundwasserspiegels bei Wasserentnahme über eine längere Zeit.
| todo
| öffentlich
4+| *Geometrie*
| - - -
