...
Die Werte stammen aus Kapitel 2.2.3.1 in [3]. Im Normalfall gelangen die durch den Bund publizierten Werte der Geologie-Codeliste zur Anwendung [<todo> Verlinkung auf https://models.geo.admin.ch/Swisstopo/GeologyModelLookUp_V2_1.xml]. Gelangt ein anderer Standard zu Anwendung, müssen die Werte zugänglich gemacht werden.
